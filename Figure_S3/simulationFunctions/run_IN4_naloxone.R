# runs the typical 4mg IN naloxone PK simulation
# called by main.R
# inputs:
...
run_IN4_naloxone <- function(fulltimes, pk_parameters, modelFolder){
    # fixed dose of 4 mg
    dose <- 4
    ...
    # update the model parameters with the 4 mg IN naloxone parameters
    truepar <- pars
